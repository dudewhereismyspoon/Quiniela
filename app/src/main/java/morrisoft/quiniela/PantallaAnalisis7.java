...
public class PantallaAnalisis7 extends Activity {
  private ArrayList<String> data;

  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.pantalla_analisis7);
    ...
    siguiente.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        bundle.putString("P7E1C1", e1c1);
        bundle.putString("P7E1C2", e1c2);
        bundle.putString("P7E1C3", e1c3);
        bundle.putString("P7E1C4", e1c4);
        bundle.putString("P7E1C5", e1c5);
        bundle.putString("P7E1C6", e1c6);
        bundle.putString("P7E1C7", e1c7);
        bundle.putString("P7E1C8", e1c8);
        bundle.putString("P7E2C1", e2c1);
        bundle.putString("P7E2C2", e2c2);
        bundle.putString("P7E2C3", e2c3);
        bundle.putString("P7E2C4", e2c4);
        bundle.putString("P7E2C5", e2c5);
        bundle.putString("P7E2C6", e2c6);
        bundle.putString("P7E2C7", e2c7);
        bundle.putString("P7E2C8", e2c8);

        Intent intent = new Intent(PantallaAnalisis7.this, PantallaAnalisis8.class);
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    getMenuInflater().inflate(R.menu.menu_pantalla_analisis7, menu);
    return true;
  }
